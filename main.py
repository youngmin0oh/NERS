...
from env import Env
from memory import ReplayMemory, NERS
...
parser.add_argument('--replay-type', type=str, default='NERS')
...
if args.model is not None and not args.evaluate:
  ...
  elif 'NERS' in args.replay_type:
    mem = NERS(args, args.memory_capacity)
  else:
    print("Only NERS and PER are available to this code")
    assert False
...
if args.evaluate:
  ...
  for T in trange(1, args.T_max + 1):
    if T % args.evaluation_interval == 0:
      ...
      if args.replay_type == 'NERS':
        mem.learn(avg_reward, avg_Q)  # update NERS
